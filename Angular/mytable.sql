...
-- Χρόνος δημιουργίας: 28 Μαρ 2019 στις 10:50:42
...
(100, 'Alvin Hale', 'Fusce.mollis@sociis.net', 'Sed dictum. Proin eget odio. Aliquam vulputate ullamcorper magna. Sed'),
(105, 'Abc', 'p09seiran@gmail.com', 'asd');
...
--
ALTER TABLE `mytable`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id` (`id`), ADD UNIQUE KEY `id_2` (`id`), ADD UNIQUE KEY `Email` (`Email`), ADD UNIQUE KEY `Name` (`Name`), ADD UNIQUE KEY `Name_2` (`Name`);
...
--
ALTER TABLE `mytable`
MODIFY `id` int(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=106;
